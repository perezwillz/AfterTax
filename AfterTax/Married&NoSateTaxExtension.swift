//
//  Married&NoSateTaxExtension.swift
//  AfterTax
//
...
extension TaxPayerController {
    func calculateAmountForMarriedWithoutStateTaxes(hours: Double)-> Double{
        ...
        case _ where federalIncomeAfterAllowance > 11761 && federalIncomeAfterAllowance <= 1000000000000000000000000000000000000000000000000:
            
            let remainder = grossPay - 11761
